...
# 2. Construct Support Vector Regression (SVR) Model
...
# 4. Use SVR to predict future pet food export values
...
for i in range(len(years_future)):
    print(f'{years_future[i]}: {pet_food_export_value_svr_future[i]:.2f} USD Billion')
